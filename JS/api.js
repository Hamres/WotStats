export const getStatsData = async (nickname) => {
  try {
    ...
    const response = await fetch(`https://api.tanki.su/wot/account/list/?application_id=092ce98e1d0e4584d8c87eb08d4b529a&search=${nickname}`)
    ...
    const responseId = await fetch(`https://api.tanki.su/wot/account/info/?application_id=092ce98e1d0e4584d8c87eb08d4b529a&account_id=${accountId}`)
